package com.automattic.simplenote.sync;
...
public class SyncTests {
    ...
    @Test
    public void publishNoteTest() throws InterruptedException {
        ...
        waitForViewMatching(withText(R.string.all_notes), 500);

        // Creating one
        addNoteFromNoteList("The title", "The content");

        // Deleting it
        deleteNoteFromNoteList("The title");
    }
    ...
    private void addNoteFromNoteList(String title, String content) {
        getViewById(R.id.fab_button).perform(click());

        waitForViewMatching(withId(R.id.note_content), 5000);

        getViewById(R.id.note_content)
                .perform(click())
    ...
    private void deleteNoteFromNoteList(String title) {
    ...
    private void waitForNotesInNotesListToLoad() throws InterruptedException {
        ...
        // TODO: Modified
        waitForViewMatching(allOf(withId(R.id.note_title), withText("Test 2")), 5000);
